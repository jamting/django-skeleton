...
ADMINS = (
    (u'Mattias Jämting', 'mattias@jwd.se'),
)
...
STATICFILES_DIRS = (
    ...
    os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(__file__))), 'initializr'),
)
...
MIDDLEWARE_CLASSES = (
    ...
    'debug_toolbar.middleware.DebugToolbarMiddleware', # Order is important: http://pypi.python.org/pypi/django-debug-toolbar   'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'myproject.middleware.XForwardedForMiddleware',
)
